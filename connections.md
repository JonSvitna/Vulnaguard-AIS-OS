...
| 4 | Communication | Microsoft 365 mailbox via Microsoft Graph (`scripts/microsoft365_api.py`); Slack via bot token (`scripts/slack_api.py` + `references/slack-api.md`) — bot invited to `#all-vulnaguard-sentinel` (`C0AMQU5HN2G`), test message sent live 2026-06-20 | key+ref | MS365: app-only (client credentials), admin consent granted; Slack: bot token (`xoxb-`) | 2026-06-20 |
